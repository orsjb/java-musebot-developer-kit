package org.musicalmetacreation.musebot.conductor;
...
import org.musicalmetacreation.musebot.util.EZShell;
...
import org.musicalmetacreation.musebot.util.AudioErrorHandler;
...
import org.musicalmetacreation.musebot.util.JackShellController;
...
//		ac = new AudioContext();
	...
	void addLocalhostToHostList() {
		...
		while(!new File(musebotLocation).exists()) {
			musebotLocation = new File(musebotLocation).getParentFile().getParentFile() + "/Musebots";
		}
